...
-- bu ürünün product_name'i elimde. yani products tablosunu kullanacaðým. istenen ise bunun State'i, o da sales.customers tablosunda,
...
-- Hata verdi. çünkü EXISTS kullanýran subquery ile query'i join yapmanýz gerekir
