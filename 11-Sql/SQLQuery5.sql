...
SELECT A.product_name, COUNT(A.product_name) as counts
FROM production.products AS A
...
SELECT A.brand_name, AVG(B.list_price) AS avg_list_price
FROM production.brands AS A, production.products AS B --burada , koyup joýn koymamýþ altta on yerine where var
